...
import logo from "../assets/logo.jpeg"; // Assuming you have a logo file in assets
    ...
    >
      <div className="navbar">
        <div className="navbar-start">
          ...
          <a className="px-2 text-xs md:text-xl hidden md:block font-bold">
            Siddhi Learning Hub
          </a>
        </div>
          ...
          {authUser ? (
            <div className="dropdown dropdown-end">
              ...
              >
                ...
                <span className="hidden md:block">{authUser.fullname}</span>
              </div>
              <ul
                tabIndex={0}
